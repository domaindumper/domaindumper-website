    ...
    <>
          ...
          <div className="row">
            <div className="col-md-4 mb-6 mb-md-0" data-aos="fade-up">
              <FeatureIconDefault
                ...
                color="primary"
                title="Analytics"
                description="Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod tempor dolore magna aliqua enim ad minim veniam."
              />
            </div>
            <div
              className="col-md-4 mb-6 mb-md-0"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <FeatureIconDefault
        ...
        <div className="container pt-9 pt-lg-11">
          <div className="row align-items-center">
            <div className="col-lg-8 mx-auto text-center mb-7">
              ...
              <div
                className="bg-primary width-80 my-7 mx-auto pt-1 rounded-pill"
                data-aos="fade-up"
                data-aos-delay="100"
              ></div>
            </div>
            ...
            <div className="row justify-content-around" data-aos="zoom-in-down">
              <div className="col-md-5 col-xl-4 mt-7 mt-lg-11">
                <FeatureIconVertical
                  ...
                  description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip commodo."
                />
              </div>
              <div
                className="col-md-5 col-xl-4 mt-7 mt-lg-11"
      ...
      <section>
        <div className="container">
          <TestimonialBoxed
            classes="bg-primary rounded-4 shadow-lg text-white py-7 px-4"
            userpost="Marketing manager"
            username="John Doe"
            comment="“ We were looking for an innovation partner that could be provide all the components that we needed. SaaS, with its abilities was a good match.”"
            brandLogo={airbnb}
            profilePic={airbnbAvatar}
          />
        </div>
      </section>
      <section className="position-relative">
        ...
        <div className="container py-9 py-lg-11 position-relative z-index-1">
          ...
          <div className="row pb-6">
            <div className="col-md-6 mt-4">
              <div
                className="bg-white bg-opacity-10 rounded-4 p-4"
                data-aos="fade-up"
              >
                <FeatureIconLeft
                  icon={

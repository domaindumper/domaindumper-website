...
const navigation = {
  products: [
    ...
    { name: 'Domain Database', href: '/domains/' },
    { name: 'TLD and gTLD', href: '/tlds/' },
    { name: 'Registrar Data', href: '/registrars/' },
  ],
  company: [
    { name: 'About Us', href: '/about/' },
    { name: 'API Documents', href: '/api-docs/' },
      ...
      <div className="container pt-9 pt-lg-11 pb-4 position-relative z-index-1">
        <div className="row">
          ...
          <div className="col-md-6 col-lg-3 mb-5">
            <div className="mb-4">
              <Link className="text-reset d-table width-120" href="/" aria-label="DomainDumper Home">
                <Image
                  src={footerLogo}
                  width={704}
                  height={178}
                  layout="responsive"
                  alt="DomainDumper Logo"
                  priority
                />
              </Link>
            </div>
            <p className="text-muted">
              Your go-to for finding and buying the perfect domain name at the best price. 
              We offer free API access for all our domain services.
            </p>
          </div>

          {/* Products Navigation */}
          <div className="col-md-3 mx-auto col-lg-2 mb-5">
            <h6 className="text-white mb-4 fw-bold">Products</h6>
            <ul className="nav flex-column">
              {navigation.products.map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="nav-link p-0 mb-3 text-muted hover-text-white">
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="col-lg-4 mb-5">
            <div className="newsletter-form">
              <h6 className="mb-4 text-white fw-bold">Subscribe to newsletter</h6>
              <form onSubmit={handleSubscribe} className="mb-3">
                ...
                {subscriptionStatus && (
                  <div className={`text-${subscriptionStatus.includes('failed') ? 'danger' : 'success'} small mt-2`}>
                    {subscriptionStatus}
                  </div>
                )}
              </form>
            ...
            <div className="d-flex flex-wrap social-links mb-5 gap-3">
            ...
            <small className="text-muted d-block mt-4">
              © {currentYear} DomainDumper. All rights reserved.
            </small>
          </div>
        </div>
      </div>
